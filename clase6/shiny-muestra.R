...
#toda la info en el repo de Hernán Escudero: https://github.com/hernanescu/datanerdes_shiny
# Levantamos datasets
calidad <- read_csv('http://cdn.buenosaires.gob.ar/datosabiertos/datasets/calidad-de-aire/calidad-de-aire-2019.csv') %>% 
